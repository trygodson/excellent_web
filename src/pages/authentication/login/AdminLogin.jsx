...
const AdminLogin = () => {
  ...
  const { loginFormScheme, submitLoginForm, handleRemember, onEyeClick, eye, rememberme } = useContext(AdminContext);
  ...
  const {
    ...
    defaultValues: {
      email: 'admin@dreamstechnologies.com',
      password: 'Dreams@99',
    },
  });
  ...
  return (
    <>
      <Helmet>
        <title>{companyTitle || 'Excellent Contructions'}</title>
                ...
                <div className="login-right-wrap">
                  ...
                  <div>
                    <form onSubmit={handleSubmit(submitLoginForm)}>
                        ...
                        <div className="row">
                          <div className="col-6">
                            <div className="custom-control custom-checkbox d-flex">
                              ...
                              />
                              <label className="custom-control-label ms-1 mb-0" htmlFor="cb1">
                                Remember me
                              </label>
                            </div>
                          </div>
                      ...
                      <button className="btn btn-lg btn-block w-100 btn-primary w-100" type="submit">
                        Login
                      </button>
                    </form>
