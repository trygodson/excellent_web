...
import { itemRender, onShowSizeChange } from '../../../../common/paginationfunction';
      ...
      render: (record) => (
        <>
          <div className="d-flex align-items-center">
            {(ledger?.create || admin) && (
              <Link to={{ pathname: `${'/add-ledger'}/${record._id}` }} className="btn btn-greys me-2">
                ...
                <div className="dropdown-menu dropdown-menu-end">
                  <ul>
                    {(admin || permission?.update) && (
                      <li>
                        <Link className="dropdown-item" to={{ pathname: `${'/edit-vendors'}/${record._id}` }}>
