...
import { handleCharacterRestrictionSpace, handleNumberRestriction } from '../../../../constans/globals';

const AddVendors = () => {
  const { addvendorPageschema, SubmitVendorForm, radio2, radio1, setRadio2, setRadio1 } = useContext(AddvendorContext);
