...
const ListChallans = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Link to={admin || view ? { pathname: `${'/view-delivery-challan'}/${record?._id}` } : '#'}>
          <span>{text}</span>
        </Link>
      ),
    },
            ...
            <h2 className="table-avatar">
              <Link to="#" className="avatar avatar-sm me-2">
                <img
                  ...
                  src={record?.customerId?.image ? record?.customerId?.image : PreviewImg}
                  alt="User Image"
                />
              </Link>
              <Link to="#">
            ...
            <div className="dropdown dropdown-action">
              ...
              <div className="dropdown-menu dropdown-menu-right quatation-dropdown dc-dropdown-menu">
                <ul>
                  {(update || admin) && (
                    <li>
                      <Link className="dropdown-item" to={`/edit-delivery-challan/${record?._id}`}>
