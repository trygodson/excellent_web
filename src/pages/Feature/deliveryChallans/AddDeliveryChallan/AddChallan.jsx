      ...
      render: (text, record) => {
        return (
          <input
            ...
            value={productOptionCopy.find((ele) => ele.id == record?._id)?.quantity}
          ...
          <>
            <div className="d-flex align-items-center">
              ...
              <Link to="#" className="btn-action-icon">
                <Popconfirm title="Sure you want to delete?" onConfirm={() => handleDelete(record._id)}>
                  <span>
                        ...
                        <div className="form-group input_text">
                          ...
                          <Controller
                            ...
                            render={({ field: { value, onChange } }) => (
                              <input
                                className={`form-control ${errors?.deliveryChallanNumber ? 'error-input' : ''}`}
                                type="text"
                                value={num}
                            ...
                            defaultValue=""
                          />
                          <small>{errors?.deliveryChallanNumber?.message}</small>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 col-sm-12">
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="form-group date-form-group">
                          ...
                          <Controller
                            ...
                            render={({ field: { value, onChange, ref } }) => (
                              <DatePickerComponent disabledDate={disableFutureDate} value={value} onChange={onChange} />
                            )}
                          ></Controller>
                          {/* For antd Datepicker */}
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            <ul className="form-group-plus css-equal-heights">
                              ...
                              <li>
                                <Link className="btn btn-primary form-plus-btn" to={`/edit-customer/${customer.id}`}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-6 col-lg-12">
                        <iframe
                          ...
                          src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJd_Y0eVIvkIARuQyDN0F1LBA&key=AIzaSyAtG3F5xOyFXuQZb86tRDnT1DNm3ynH9rc"
                        />
                      </div>
                            ...
                            <div className="invoice-total-inner">
                              <p>
                                ...
                                <span>
                                  {currencyData ? currencyData : '$'}
                                  {/* {calculateSum()} */}
                                  {Number(calculateTaxableSum()).toLocaleString('en-IN', {
                              ...
                              <p>
                                ...
                                <span>
                                  {currencyData ? currencyData : '$'}
                                  {/* {calculateDiscount()} */}
                                  {Number(calculateDiscount()).toLocaleString('en-IN', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                  })}
                                </span>
                              ...
                              <p>
                                ...
                                <span>
                                  ...
                                  {Number(calculateTax()).toLocaleString('en-IN', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                  })}
                                </span>
                              ...
                              <h4>
                                ...
                                <span>
                                  ...
                                  {/* {round
                                    ? Math.round(calculateSum())
                                    : calculateSum()} */}
                                  {Number(round ? Math.round(calculateSum()) : calculateSum()).toLocaleString('en-IN', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                  })}
                                </span>
