...
const Sidebar = () => {
  ...
  useEffect(() => {
    if ('/manage-user' === pathName || '/add-user' === pathName || '/users' === pathName) {
  ...
  useEffect(() => {
    if (userDetails?.permissionRes?.modules?.length > 0) {
      const requiredModules = userDetails?.permissionRes?.modules
        .filter(
          (user) =>
            (user.permissions.create || user.permissions.update || user.permissions.delete || user.permissions.view) &&
          ...
          <div className="sidebar-logo">
            <Link to="/index">
              {companyData?.siteLogo ? (
                ...
                <>
                  <h4 style={{ fontWeight: 'bold' }}>Excellent</h4> <p style={{ fontSize: 12 }}>Contructions</p>
                </>
              )}
            </Link>
            <Link to="/index">
              <img
                src={companyData?.companyLogo ? companyData?.companyLogo : LogoSmallImg}
          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              ...
              <ul>
                ...
                <li className={`${'/index' === pathName || '/' === pathName ? 'active' : ''}`}>
              ...
              <ul
                style={{
                  display: showHide('customer') && showHide('vendor') ? 'none' : 'block',
                }}
              >
                <li className="menu-title">
                  <span>Projects</span>
                ...
                <li
                  className={`${'/projects' === pathName || '/add-projects' === pathName ? 'active' : ''}`}
                ...
                >
                  <Link to="/vendors">
                    <FeatherIcon icon="user" /> <span>SubContractors</span>
                  </Link>
                </li>
              </ul>
              {/* /Customers */}
              ...
              >
                <li className="menu-title">
                  <span>Tender Tracking</span>
                </li>
                <li
                  className={`${'/tender-tracking' === pathName || '/add-tender' === pathName ? 'active' : ''}`}
                  // style={{ display: showHide("customer") ? "none" : "block" }}
                >
                  <Link to="/tender-tracking">
                    <FeatherIcon icon="users" />
                    <span>Tender Tracking</span>
                  </Link>
                </li>
              ...
              >
                <li className="menu-title">
                  <span>Contract Mangement</span>
                </li>
                <li
                  className={`${'/contract-management' === pathName || '/add-contract' === pathName ? 'active' : ''}`}
                  // style={{ display: showHide("customer") ? "none" : "block" }}
                >
              ...
              >
                <li className="menu-title">
                  <span>Budget Mangement</span>
                </li>
                <li
                  className={`${'/budget-management' === pathName || '/add-budget' === pathName ? 'active' : ''}`}
                  // style={{ display: showHide("customer") ? "none" : "block" }}
                >
              ...
              <ul
                style={{
                  display:
                    showHide('purchase') && showHide('purchaseOrder') && showHide('purchasereturn') ? 'none' : 'block',
                }}
              >
                <li className="menu-title">
                ...
                >
                  <Link to="/purchase-orders" onClick={() => toggleSidebar('')}>
                    <FeatherIcon icon="shopping-cart" /> <span>Purchase Orders</span>
                  </Link>
                </li>
                <li
                  className={`${
                ...
                >
                  <Link to="/debit-notes" onClick={() => toggleSidebar('')}>
                    <FeatherIcon icon="file-text" /> <span>Purchase Return</span>
                  </Link>
                </li>
              </ul>
              {/* /Purchases */}
              ...
              <ul
                style={{
                  display:
                    showHide('productsOrServices') && showHide('category') && showHide('unit') && showHide('inventory')
                      ? 'none'
                      : 'block',
                }}
              >
                ...
                >
                  <Link
                    ...
                    onClick={() => {
                      toggleSidebar(isSideMenu == 'product-service' ? '' : 'product-service');
                    }}
                    style={{
                      display:
                        showHide('productsOrServices') && showHide('category') && showHide('unit') ? 'none' : 'block',
                    }}
                  >
                    <FeatherIcon icon="package" /> <span> Product / Services</span> <span className="menu-arrow"></span>
                  </Link>

                  <ul className={isSideMenu == 'product-service' ? 'd-block' : 'd-none'}>
                    <li
                      style={{
                        display: showHide('productsOrServices') ? 'none' : 'block',
                      }}
                    >
                      <Link to="/product-list" className={`${'/product-list' === pathName ? 'active' : ''}`}>
                        Product List
                      </Link>
                    </li>
                    <li
                    ...
                    >
                      <Link to="/category" className={`${'/category' === pathName ? 'active' : ''}`}>
                        Category
                      </Link>
                    </li>
                    <li
                    ...
                    >
                      <Link to="/units" className={`${'/units' === pathName ? 'active' : ''}`}>
                        Units
                      </Link>
                    </li>
                  </ul>
                ...
                <li
                  className={`${'/inventory' === pathName ? 'active' : ''}`}
                  style={{
              ...
              <ul
                style={{
                  display: showHide('quotation') && showHide('deliveryChallan') ? 'none' : 'block',
                }}
              >
                <li className="menu-title">
                ...
                >
                  <Link to="/delivery-challans" onClick={() => toggleSidebar('')}>
                    <FeatherIcon icon="book-open" /> <span>Deliveries</span>
                  </Link>
                </li>
              </ul>
              {/* /Quotations */}
              ...
              >
                ...
                >
                  <Link to="/payment-summary" onClick={() => toggleSidebar('')}>
                    <FeatherIcon icon="credit-card" /> <span>Payment Summary</span>
                  </Link>
                </li>
              </ul>
              {/* /Reports */}
              ...
              >
                ...
                <li
                  className={`${
                    '/manage-user' === pathName || '/add-user' === pathName || '/users' === pathName
                      ? 'active submenu'
                      : 'submenu'
                  }`}
                  style={{
                ...
                >
                  <Link
                    ...
                    onClick={() => toggleSidebar(isSideMenu == 'manage-user' ? '' : 'manage-user')}
                  >
                  ...
                  <ul
                    className={isSideMenu == 'manage-user' ? 'd-block' : 'd-none'}
                    style={{
                      display: showHide('user') ? 'none' : 'block',
                    }}
                  >
                    ...
                    >
                      <Link to="/users" className={`${'/users' === pathName ? 'active' : ''}`}>
                        Users
                      </Link>
                    </li>
                  </ul>
                ...
                <li
                  className={`${'/roles-permission' === pathName || pathName.includes('/permission/') ? 'active' : ''}`}
                  style={{
                    display: showHide('role') ? 'none' : 'block',
                  }}
                >
                  <Link to="/roles-permission" onClick={() => toggleSidebar('')}>
                    <FeatherIcon icon="clipboard" /> <span>Roles &amp; Permission</span>
                  </Link>
                </li>

                <li style={{ cursor: 'pointer', alignItems: 'center' }} onClick={() => logoutPage()}>
