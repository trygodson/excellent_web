...
const EditBudget = () => {
  ...
  const changeRoundoff = (val) => {
    ...
    if (val == true) {
      let roundValue =
        Math.round(Number(taxableAmount) + Number(totalTax) - Number(totalDiscount)) -
        (Number(taxableAmount) + Number(totalTax) - Number(totalDiscount));
      setroundofValue(roundValue.toFixed(2));
      settotalAmount(Math.round(Number(taxableAmount) + Number(totalTax) - Number(totalDiscount)).toFixed(2));
    } else {
      setroundofValue((0).toFixed(2));
      settotalAmount((Number(taxableAmount) + Number(totalTax) - Number(totalDiscount)).toFixed(2));
    }
  };
  ...
  useEffect(() => {
    let paymentmethodobj = paymentmethodsData.find((obj) => obj.value == invoiceData?.payment_method);
    ...
    if (invoiceData?.roundOff == true) {
      let roundValue =
        Math.round(Number(rate) + Number(vat) - Number(discount)) - (Number(rate) + Number(vat) - Number(discount));
      setroundofValue(roundValue.toFixed(2));
      settotalAmount(Math.round(Number(rate) + Number(vat) - Number(discount)).toFixed(2));
    } else {
      setroundofValue((0).toFixed(2));
  ...
  const editModal = (data) => {
    ...
    editsetValue('discountType', Number(data.form_updated_discounttype).toFixed(2));
  ...
  const addTableRows = (product_id) => {
    if (product_id != '') {
      ...
      setrowErr([...rowErr, { field: `qtyInput${count}`, valid: true, key: count }]);
      setCount(count + 1);
    }
  };
  ...
  const addTaxratesForm = async (data) => {
    ...
    if (enteredVlaue != undefined) {
      ...
      row.amount = (Number(row.rate) + Number(row.tax) - Number(row.discount)).toFixed(2);
        ...
        <>
          <div className="d-flex align-items-center">
            ...
            <Link to="#" className="btn-action-icon">
              <Popconfirm title="Sure to delete?" onConfirm={() => handleDelete(record.key, record.productId)}>
                <span>
              ...
              <div className="col-md-12">
                <div className="card-body">
                        ...
                        <div className="form-group input_text">
                          ...
                          <Controller
                            ...
                            render={({ field: { value, onChange } }) => {
                              return (
                                <input
                                  className={`form-control ${errors?.invoiceNumber ? 'error-input' : ''}`}
                                  type="text"
                                  value={value || ''}
                                  onChange={onChange}
                                  readOnly={true}
                        ...
                        <div className="form-group input_text">
                          ...
                          <ul className="form-group-plus css-equal-heights">
                            <li>
                              ...
                              />
                              <small className="text-danger">{errors?.customerId?._id?.message}</small>
                            </li>
                            <li>
                              <Link className="btn btn-primary form-plus-btn" to="/add-customer">
                        ...
                        <div className="form-group input_text">
                          ...
                          <Controller
                            ...
                            render={({ field: { value, onChange } }) => {
                              return (
                                <input
                                  className={`form-control ${errors?.referenceNo ? 'error-input' : ''}`}
                                  type="text"
                                  onKeyPress={handleNumberRestriction}
                                  value={value || ''}
                                  onChange={onChange}
                          ...
                          />
                          <small className="text-danger">{errors?.referenceNo?.message}</small>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="form-group input_text">
                      ...
                      <div className="col-lg-12">
                        <div className="form-group">
                          ...
                          <ul className="form-group-plus css-equal-heights">
                            ...
                            <li>
                              <Link className="btn btn-primary form-plus-btn" to="/add-product">
                                <i className="fas fa-plus-circle" />
                              </Link>
                            </li>
                          </ul>
                        ...
                        <div className="form-group-bank">
                          ...
                          <div className="form-group input_text notes-form-group-info mb-0">
                            ...
                            <Controller
                              ...
                              render={({ field: { value, onChange } }) => (
                                <textarea
                                  className={`form-control ${errors?.termsAndCondition ? 'error-input' : ''}`}
                                  type="text"
                                  value={value || ''}
                                  onChange={onChange}
                            ...
                            />
                            <small className="text-danger">{errors?.termsAndCondition?.message}</small>
                          </div>
                        </div>
                      </div>
                      <div className="col-xl-6 col-lg-12">
                  ...
                  <div className="text-end">
                    <Link to="/invoice-list" type="reset" className="btn btn-primary cancel me-2">
                      Cancel
                    </Link>
          ...
          <form onSubmit={addTaxratesFormhandle(addTaxratesForm)}>
            <div className="modal-content">
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        type="hidden"
                        control={editTaxratesFormControl}
                        render={({ field: { value, onChange } }) => <input type="hidden" value={value || ''} />}
                      />
                      <Controller
                        name={`productId`}
                        type="hidden"
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${errors?.rate ? 'error-input' : ''}`}
                            type="number"
                            value={value || ''}
                            onChange={onChange}
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${errors?.discount ? 'error-input' : ''}`}
                            type="number"
                            value={value || ''}
                            onChange={onChange}
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-primary paid-continue-btn" type="submit">
                  Save
                </button>
              </div>
            </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="modal-btn delete-action">
                <div className="row">
                  <div className="col-6">
                    <Link to="#" data-bs-dismiss="modal" className="btn btn-primary paid-continue-btn">
                      Delete
                    </Link>
                  </div>
                  <div className="col-6">
                    <Link to="#" data-bs-dismiss="modal" className="btn btn-primary paid-cancel-btn">
                      Cancel
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${addBankerrors?.bankName ? 'error-input' : ''}`}
                            type="text"
                            value={value || ''}
                            onChange={onChange}
                        ...
                        defaultValue=""
                      />
                      <small className="text-danger">{addBankerrors?.bankName?.message}</small>
                    </div>
                  </div>
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${addBankerrors?.accountNumber ? 'error-input' : ''}`}
                            type="number"
                            value={value || ''}
                            onChange={onChange}
                        ...
                        defaultValue=""
                      />
                      <small className="text-danger">{addBankerrors?.accountNumber?.message}</small>
                    </div>
                  </div>
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${addBankerrors?.name ? 'error-input' : ''}`}
                            type="text"
                            value={value || ''}
                            onChange={onChange}
                        ...
                        defaultValue=""
                      />
                      <small className="text-danger">{addBankerrors?.name?.message}</small>
                    </div>
                  </div>
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${addBankerrors?.branch ? 'error-input' : ''}`}
                            type="text"
                            value={value || ''}
                            onChange={onChange}
                        ...
                        defaultValue=""
                      />
                      <small className="text-danger">{addBankerrors?.branch?.message}</small>
                    </div>
                  </div>
                  <div className="col-lg-12 col-md-12">
                    <div className="form-group input_text mb-0">
                      ...
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <input
                            className={`form-control ${addBankerrors?.IFSCCode ? 'error-input' : ''}`}
                            type="text"
                            value={value || ''}
                            onChange={onChange}
                        ...
                        defaultValue=""
                      />
                      <small className="text-danger">{addBankerrors?.IFSCCode?.message}</small>
                    </div>
                  </div>
                </div>
              </div>
