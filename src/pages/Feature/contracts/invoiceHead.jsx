...
import { Recepit, TransactionMinus, ArchiveBook, MessageEdit, FilterIcon } from '../../../common/imagepath';
import { invoice } from '../../../core/core-index';
import { ApiServiceContext } from '../../../core/API/api-service';

const InvoiceHead = ({ show, setShow, invoicelistData, currencyData, amountFormat, permission, admin }) => {
        ...
        <div className="content-page-header">
          ...
          <div className="list-btn">
            <ul className="filter-list">
              <li>
                <Link className="btn btn-filters w-auto popup-toggle" onClick={() => setShow(!show)}>
                  <span className="me-2">
              ...
              {(create || admin) && (
                <li>
                  <Link className="btn btn-primary" to="/add-contracts">
            ...
            <div className="card-body">
              <div className="dash-widget-header">
                ...
                <div className="dash-count">
                  <div className="dash-title">Total Returns</div>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <p className="inovices-all">
                  No of Contracts <span className="rounded-circle bg-light-gray">{total_invoice?.count || 0}</span>
                </p>
                <p className="inovice-trending text-success-light"></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card inovices-card w-100">
            <div className="card-body">
              <div className="dash-widget-header">
                ...
                <div className="dash-count">
                  <div className="dash-title">Pending Contracts</div>
                  <div className="dash-counts">
                    <p>
                      {currencyData}
                      {amountFormat(
                        totalSum(
                          totaloutstanding?.total_sum ? totaloutstanding?.total_sum : 0,
                          totalOverdue?.total_sum ? totalOverdue?.total_sum : 0,
                          total_drafted?.total_sum ? total_drafted?.total_sum : 0,
                        ),
                      )}
                    </p>
                  </div>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <p className="inovices-all">
                  No of Outstandings{' '}
                  <span className="rounded-circle bg-light-gray">{totaloutstanding?.count || 0}</span>
                </p>
                <p className="inovice-trending text-success-light"></p>
              </div>
            </div>
        ...
        <div className="col-sm-3 col-12 d-flex">
          <div className="card inovices-card w-100">
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center">
                <p className="inovices-all">
                  No of Overdues <span className="rounded-circle bg-light-gray">{totalOverdue?.count || 0}</span>
                </p>
                <p className="inovice-trending text-danger-light"></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card inovices-card w-100">
            <div className="card-body">
              <div className="dash-widget-header">
                ...
                <div className="dash-count">
                  <div className="dash-title">Rejected</div>
                  <div className="dash-counts">
                    <p>
                      {currencyData}
              ...
              <div className="d-flex justify-content-between align-items-center">
                <p className="inovices-all">
                  No of Rejected <span className="rounded-circle bg-light-gray">{total_drafted?.count || 0}</span>
                </p>
                <p className="inovice-trending text-danger-light"></p>
              </div>
            </div>
