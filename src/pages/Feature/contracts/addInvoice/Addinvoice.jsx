...
const AddInvoice = () => {
  ...
  const handleChanges = (evnt, key) => {
    ...
    if (row.isRateFormUpadted) {
      ...
      resetRowdataBeforediscount = row?.form_updated_discount ? row?.form_updated_discount : 0;
      resetRowdataBeforetax = row?.form_updated_tax ? row?.form_updated_tax : 0;
    } else {
      resetRowdataBeforerate = resetRowdataBefore?.sellingPrice;
      resetRowdataBeforediscount = resetRowdataBefore?.discountValue ? resetRowdataBefore?.discountValue : 0;
      resetRowdataBeforetax = resetRowdataBefore?.tax?.taxRate ? resetRowdataBefore?.tax?.taxRate : 0;
    }
                    ...
                    <div className="row align-item-center">
                              ...
                              <Controller
                                ...
                                render={({ field }) => (
                                  <Select
                                    ...
                                    isDisabled={Object.keys(ChoosedCustomer).length < 1 ? false : true}
                                  />
                                )}
                              />
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="form-group date-form-group">
                          ...
                          <Controller
                            control={control}
                            className={`form-control ${errors?.invoiceDate ? 'error-input' : ''}`}
                            name="invoiceDate"
                            render={({ field: { value, onChange } }) => (
                              <>
                                <DatePickerComponent
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="form-group date-form-group">
                          ...
                          <Controller
                            name="dueDate"
                            control={control}
                            className={`form-control ${errors?.dueDate ? 'error-input' : ''}`}
                            render={({ field: { value, onChange } }) => (
                              <DatePickerComponent disabledDate={disablePastDate} value={value} onChange={onChange} />
                            )}
                          ></Controller>
                        ...
                        <div className="form-group">
                          ...
                          <ul className="form-group-plus css-equal-heights">
                            <li>
                              ...
                              />
                              <small className="text-danger">{errors?.products?.value?.message}</small>
                            </li>
                            <li>
                                  ...
                                  render={({ field }) => (
                                    <>
                                      <Select
                                        ...
                                        classNamePrefix="select_kanakku"
                                      />
                                      <small className="text-danger">{errors?.bank?._id.message}</small>
                                    </>
                                  )}
                                />
                              </div>
