      ...
      render: (record) => (
        <>
          <div className="table-invoice d-flex align-items-center">
            {record?.status == 'Active' ? (
              <Link to={`/add-invoice?cid=${record._id}`} className="btn btn-greys me-2">
                <i className="fa fa-plus-circle me-1" /> View
              </Link>
            ) : (
              <></>
            )}
              ...
              <div className="dropdown-menu dropdown-menu-end customer-dropdown-menu">
                <ul>
                  ...
                  {record.status == 'Deactive' &&
                    (permission?.create || permission?.update || permission?.view || admin) && (
                      <li>
                        <Link className="dropdown-item" onClick={() => activate(record._id, 'activate')}>
                  ...
                  {record.status == 'Active' && (permission?.create || permission?.update || admin) && (
                    <li>
                      <Link className="dropdown-item" onClick={() => activate(record._id, 'deactivate')}>
              ...
              <div className="list-btn">
                <ul className="filter-list">
                  ...
                  {(admin || permission?.create) && (
                    <li>
                      <Link className="btn btn-primary" to="/add-projects">
