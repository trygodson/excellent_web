...
const AddCustomers = () => {
  const { addCustomerschema, setFileImage, getBase64, onSubmit, setFile } = useContext(AddCustomerContext);
  ...
  const copyBill = () => {
    ...
    setValue('shippingAddress[name]', formData?.billingAddress?.name, validateError);
    setValue('shippingAddress[addressLine1]', formData?.billingAddress?.addressLine1, validateError);
    setValue('shippingAddress[addressLine2]', formData?.billingAddress?.addressLine2, validateError);
    setValue('shippingAddress[state]', formData?.billingAddress?.state, validateError);
    setValue('shippingAddress[country]', formData?.billingAddress?.country, validateError);
    setValue('shippingAddress[city]', formData?.billingAddress?.city, validateError);
    setValue('shippingAddress[pincode]', formData?.billingAddress?.pincode, validateError);
  };
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="card-body">
                    ...
                    <div className="profile-picture">
                      ...
                      <div className="img-upload">
                        <label className="btn btn-primary">
                          Upload <input type="file" ref={fileInputRef} onChange={handleFileUpload} />
                        </label>
                        <Link className="btn btn-remove" onClick={handleRemoveImage}>
                          Remove
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="row">
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.billingAddress?.name && (
                                  <p className="text-danger">{errors.billingAddress?.name?.message}</p>
                                )}
                              </>
                            )}
                            defaultValue=""
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.billingAddress?.addressLine1 && (
                                  <p className="text-danger">{errors.billingAddress?.addressLine1?.message}</p>
                                )}
                              </>
                            )}
                            defaultValue=""
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.billingAddress?.addressLine2 && (
                                  <p className="text-danger">{errors.billingAddress?.addressLine2?.message}</p>
                                )}
                              </>
                            )}
                            defaultValue=""
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.billingAddress?.city && (
                                      <p className="text-danger">{errors.billingAddress?.city?.message}</p>
                                    )}
                                  </>
                                )}
                                defaultValue=""
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.billingAddress?.country && (
                                      <p className="text-danger">{errors.billingAddress?.country?.message}</p>
                                    )}
                                  </>
                                )}
                                defaultValue=""
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.billingAddress?.state && (
                                      <p className="text-danger">{errors.billingAddress?.state?.message}</p>
                                    )}
                                  </>
                                )}
                                defaultValue=""
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.billingAddress?.pincode && (
                                      <p className="text-danger">{errors.billingAddress?.pincode?.message}</p>
                                    )}
                                  </>
                                )}
                                defaultValue=""
                      ...
                      <div className="col-md-6">
                        <div className="billing-btn">
                          ...
                          <Link to="#" className="btn btn-primary" onClick={copyBill}>
                            Copy from Billing
                          </Link>
                        </div>
                        <div className="form-group">
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.shippingAddress?.name && (
                                  <p className="text-danger">{errors.shippingAddress?.name?.message}</p>
                                )}
                              </>
                            )}
                          />
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.shippingAddress?.addressLine1 && (
                                  <p className="text-danger">{errors.shippingAddress?.addressLine1?.message}</p>
                                )}
                              </>
                            )}
                          />
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.shippingAddress?.addressLine2 && (
                                  <p className="text-danger">{errors.shippingAddress?.addressLine2?.message}</p>
                                )}
                              </>
                            )}
                          />
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.shippingAddress?.city && (
                                      <p className="text-danger">{errors.shippingAddress?.city?.message}</p>
                                    )}
                                  </>
                                )}
                              />
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.shippingAddress?.country && (
                                      <p className="text-danger">{errors.shippingAddress?.country?.message}</p>
                                    )}
                                  </>
                                )}
                              />
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.shippingAddress?.state && (
                                      <p className="text-danger">{errors.shippingAddress?.state?.message}</p>
                                    )}
                                  </>
                                )}
                              />
                                ...
                                render={({ field: { value, onChange } }) => (
                                  <>
                                    ...
                                    {errors.shippingAddress?.pincode && (
                                      <p className="text-danger">{errors.shippingAddress?.pincode?.message}</p>
                                    )}
                                  </>
                                )}
                              />
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                <input
                                  ...
                                  value={value}
                                  type="text"
                                  onKeyPress={handleSpecialCharacterSpaceRestriction}
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.bankDetails?.accountHolderName && (
                                  <p className="text-danger">{errors.bankDetails?.accountHolderName?.message}</p>
                                )}
                              </>
                            )}
                          />
                            ...
                            render={({ field: { value, onChange } }) => (
                              <>
                                ...
                                {errors.bankDetails?.IFSC && (
                                  <p className="text-danger">{errors.bankDetails?.IFSC?.message}</p>
                                )}
                              </>
                            )}
                          />
                  ...
                  <div className="add-customer-btns text-end">
                    ...
                    <button name="Submit" to="/customers" className="btn btn-primary" type="submit">
                      Save Changes
                    </button>
                  </div>
                </div>
