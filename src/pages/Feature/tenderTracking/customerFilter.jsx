...
const CustomerFilter = ({ show, setShow, setList, pagesize, page, setTotalCount, setPage, handlePagination }) => {
  ...
  const handleApplyFilter = async (e) => {
    ...
    try {
      ...
      if (queryParams.length > 0) searchUrl = `${searchUrl}?${queryParams.join('&')}`;
          ...
          <div className="sidebar-body">
            <form autoComplete="off">
              ...
              <div className="accordion" id="accordionMain1">
                <div className="card-header-new" id="headingOne" onClick={() => setCustomer(!customer)}>
                  <h6 className="filter-title">
                    <Link to="#" className={customer ? 'w-100' : 'w-100 collapsed'} aria-expanded={customer}>
                      Tender
                ...
                <div id="collapseOne" className={customer ? 'collapse show' : 'collapse'}>
              ...
              <div className="filter-buttons">
                ...
                <button
                  ...
                  disabled={searchText.value == '' && key.length == 0 ? true : false}
