...
const AddCredit = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        let lastQ = productOptionCopy.find((ele) => ele.id == record?._id)?.quantity;
        return currencyData
        ...
        <>
          <div className="d-flex align-items-center">
            ...
            <Link to="#" className="btn-action-icon">
              <Popconfirm title="Sure you want to delete?" onConfirm={() => handleDelete(record._id, purchaseDelete)}>
                <span>
                  ...
                  <div className="card-body">
                          ...
                          <div className="form-group input_text">
                            ...
                            <Controller
                              ...
                              render={({ field: { value, onChange } }) => (
                                <input
                                  className={`form-control ${errors?.credit_note_id ? 'error-input' : ''}`}
                                  type="text"
                                  value={num}
                                ...
                                <Controller
                                  ...
                                  render={({ field: { value, onChange } }) => (
                                    <>
                                      ...
                                      />
                                      {errors.listData && <p className="text-danger">{errors.listData.message}</p>}
                                    </>
                                  )}
                                />
                              </li>
                    ...
                    <>
                                      ...
                                      render={({ field: { value, onChange } }) => (
                                        <>
                                          <SelectDropDown
                                            ...
                                            value={value}
                                            onChange={(v) => {
                                              // console.log(val, '----select  bank value---');
                                              onChange(v);
                                            }}
                                            {...register('bank')}
                                            goto={refer}
                              ...
                              <div className="invoice-total-box">
                                ...
                                <div className="invoice-total-footer">
                                  <h4>
                                    ...
                                    <span>
                                      {currencyData ? currencyData : '$'}
                                      {Number(round ? Math.round(calculateSum()) : calculateSum()).toLocaleString(
                                        'en-IN',
                                        {
                                          minimumFractionDigits: 2,
                                          maximumFractionDigits: 2,
                      ...
                      <div className="add-customer-btns text-end">
                        ...
                        <button value="Submit" className="btn customer-btn-save" type="submit">
                          Save
                        </button>
                      </div>
                    </>
