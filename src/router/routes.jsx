...
import TenderTrackingList from '../pages/Feature/tenderTracking/listCustomer';
import AddTenderComponent from '../pages/Feature/tenderTracking/addCustomer';
import ListContractsComponent from '../pages/Feature/contracts/contractList';
import AddContractComponent from '../pages/Feature/contracts/addInvoice';
import ListBudgetComponent from '../pages/Feature/budgets/budgetList';
import AddBudgetComponent from '../pages/Feature/budgets/addBudget';
import AddProjectsComponent from '../pages/Feature/projects/addProjectsClaims';
import ListProjectComponent from '../pages/Feature/projects/listProject';
...
export const authRoutes = [
  ...
  },
  {
    ...
    element: <ListContractsComponent />,
  },
  {
    path: `/budget-management`,
    element: <ListBudgetComponent />,
  },
  {
    path: `/add-contracts`,
    element: <AddContractComponent />,
  },
  {
    path: `/add-budget`,
    element: <AddBudgetComponent />,
  },
  {
    path: `/tender-tracking`,
    element: <TenderTrackingList />,
  },
  {
    path: '/add-tender',
    element: <AddTenderComponent />,
  },
